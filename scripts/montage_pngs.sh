...
# montage corpus-agu-hydrology.RData-1*.png corpus-agu-hydrology.RData-2*.png -tile x2 -geometry 1024x1024\>+10+10 -gravity center -crop 2600x2600+0+400  "$fn" ; convert -rotate 90 "$fn" "$fn-90" ; convert  -crop 1x5@  +repage  +adjoin "$fn-90" -rotate -90 -gravity South -annotate +0+10 "$fn" -rotate 90  "$fn.png"
